      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <div className="mt-4">
          <p className="text-gray-600">
            ¿Estás seguro de que deseas eliminar el asistente <span className="font-semibold">{assistantName}</span>?
          </p>
          <p className="text-gray-500 text-sm mt-2">
            Esta acción eliminará el asistente de WhatsApp pero <span className="font-bold">NO</span> lo eliminará de la plataforma OpenAI (platform.openai.com).
          </p>
          <p className="text-gray-500 text-sm mt-2">
